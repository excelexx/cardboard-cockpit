...
Version **0.22.5** is one continuous San Francisco judge demo: take off, fly, shoot adaptive dual plasma and keep clearing new flocks for as long as you like. The HUD keeps the aiming area clear. Press **B** or **badge B** when you want to land, then fly the approach yourself.
