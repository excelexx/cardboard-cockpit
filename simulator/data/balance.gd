...
const GROUP_SIZE := 3
const WAVE_INTERVAL := 7.5
const FIRST_ARRIVAL := WAVE_INTERVAL
const ARRIVAL_INTERVAL := WAVE_INTERVAL
...
const CONTACT_MODEL_SCALE := 24.0
...
const SKEIN_SLOT_BACK := 70.0
const SKEIN_SLOT_SIDE := 48.0
const SKEIN_SLOT_RISE := 9.0
const SKEIN_SLOT_JITTER := 10.0
...
const MISSILE_DAMAGE := 110.0
const MISSILE_INTERVAL := 5.0
const MISSILE_SPEED := 900.0
const MISSILE_ACCELERATION_TIME := .25
...
const BEAM_DPS := CONTACT_HEALTH / 2.0 # Two beams together take 1 second.
const MIN_GOOSE_ALTITUDE := 396.24 # 1,300 feet.
const GOOSE_SPAWN_DISTANCE := 2200.0
const GOOSE_DEPTH_SPACING := 400.0
const BEAM_RANGE := 3500.0
...
const SWARM_BURST_SIZE := 2
const MISSILE_BLAST_RADIUS := 35.0
const MISSILE_SPLASH_DAMAGE := 25.0
