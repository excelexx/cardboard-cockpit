...
func run() -> void:
	...
	failed=app.mode!="results" or app.mission.clock>150 or not boss_seen or not beam_seen or max_missiles<4
	...
	failed=failed or app.mode!="results" or app.mission.clock>150 or app.mission_success or app.combat.boss_defeated or app.combat.rounds_fired!=0
