...
func run() -> void:
	...
	if app.combat.kills<1 or app.combat.rounds_fired<1 or app.combat.missiles_fired!=0: failures.append("Demo did not demonstrate gun-only combat and an actual hit")
