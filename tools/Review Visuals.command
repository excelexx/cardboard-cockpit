...
"$engine" --path "$project_dir/simulator" -- --kind=campaign --flight --capture="$project_dir/docs/screenshots/immersion/departure.png" --capture-at=2
"$engine" --path "$project_dir/simulator" -- --kind=campaign --flight --capture="$project_dir/docs/screenshots/immersion/interception.png" --capture-at=38
