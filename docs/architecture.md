...
- `combat.gd`: contact tracking, cannon projectile sweeps, aim assistance, harmless geese, flare effects and an optional guided pilot.
...
- `camera_rig.gd`: cockpit/chase framing, FOV, shake and local lag.
