...
Badge: START start/replay/resume, HOME pause, A gear, B assisted landing, LEFT view, RIGHT inset, UP route assistance, DOWN text visibility. All steering/throttle/firing belongs to the cardboard controls. [Construction and switch sheet](WEAPON_SWITCHES.md).
