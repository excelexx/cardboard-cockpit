...
Normal Play uses the current branch’s flock-clearing rules and requires the aircraft to land and stop. Tutorial requires all sixteen targets and a stopped landing. Landing without the required objective reports an incomplete intercept. Completing three introductory geese is not itself mission completion. The screen, advice and radio share one assessment. Crash recovery does not produce a mission-failed screen.
